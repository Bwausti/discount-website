...
const priceSources = {
  ...
  sertaCascadeCanyonFirm: "https://www.serta.com/products/perfect-sleeper-cascade-canyon-firm-mattress",
} as const;
...
export const brands: Brand[] = [
  ...
  withBrandAssets({
    ...
    description:
      "Serta brings two clear paths into the showroom: iComfort for cooling memory foam comfort and Perfect Sleeper Cascade for zoned innerspring support.",
    showroomNote:
      "Best for shoppers who want a familiar national brand, cooling materials, and a range of Cascade comfort profiles to compare in person.",
    collectionHighlights: ["iComfort cooling", "Cascade support", "National brand"],
    products: [
      {
        id: "serta-icomfort",
        model: "Serta iComfort Mattress",
        category: "Mattress",
        type: "Memory foam",
        height: "11.5-14 in",
        firmness: "Firm, medium, or plush",
        feel: "Cool-to-the-touch foam comfort",
        badge: "Cooling",
        bestFor: ["Hot sleepers", "Foam shoppers", "All sleep positions"],
        keyFeatures: [
          "5 ZoneResponse support",
          "CoolFeel fabric",
          "Graphite-infused memory foam",
        ],
        trial: "100 nights online",
        warranty: "10 years",
      ...
      {
        id: "serta-icomfort-pro",
        model: "Serta iComfortPro Mattress",
        category: "Mattress",
        type: "Premium cooling mattress",
        firmness: "Extra firm or medium",
        feel: "Advanced cooling support",
        badge: "Premium",
        bestFor: ["Hot sleepers", "Support seekers", "Premium Serta shoppers"],
        keyFeatures: ["5-zone alignment", "Cooling memory foam", "Premium comfort levels"],
        warranty: "10 years",
        image: "/brand-assets/serta/icomfort-preview.jpg",
        gallery: [
          "/brand-assets/serta/icomfort-preview.jpg",
          "/brand-assets/icomfort/hero-medium.jpg",
          "/brand-assets/icomfort/btf-square-a.jpg",
        ],
        availability: "Call for current iComfortPro availability.",
      },
      {
        id: "serta-cascade-ridge-plush",
        model: "Serta Cascade Ridge Plush",
        category: "Mattress",
        type: "Perfect Sleeper innerspring",
        height: "12.5 in",
        firmness: "Plush",
        feel: "Cushioned support",
        badge: "Perfect Sleeper",
        bestFor: ["Side sleepers", "Pressure relief", "Classic Serta feel"],
        keyFeatures: ["Q4 support system", "5-Zone Comfort", "CoolFeel fabric"],
        trial: "100 nights online",
        warranty: "10 years",
        image: "/brand-assets/serta/sheep-lifestyle.jpg",
        gallery: [
          "/brand-assets/serta/sheep-lifestyle.jpg",
          "/brand-assets/serta/sheep-stretch.jpg",
          "/brand-assets/serta/icomfort-preview.jpg",
        ],
        availability: "Visit the showroom to compare Cascade comfort profiles.",
        onlinePrice: officialOnlinePrice({
          amount: "$599",
          label: "Starting price",
          sourceName: "Serta",
          sourceUrl: priceSources.sertaCascade,
        }),
      },
      {
        id: "serta-cascade-canyon-firm",
        model: "Serta Cascade Canyon Firm",
        category: "Mattress",
        type: "Perfect Sleeper innerspring",
        height: "13 in",
        firmness: "Firm",
        feel: "Firm zoned support",
        bestFor: ["Back sleepers", "Support seekers", "Less sink"],
        keyFeatures: ["860-density Q4 coils", "5-Zone Comfort", "CoolFeel fabric"],
        trial: "100 nights online",
        warranty: "10 years",
        image: "/brand-assets/serta/sheep-stretch.jpg",
        availability: "Call or visit to confirm Cascade Canyon floor models.",
        onlinePrice: officialOnlinePrice({
          amount: "$699",
          label: "Starting price",
          sourceName: "Serta",
          sourceUrl: priceSources.sertaCascadeCanyonFirm,
        }),
      },
      {
        id: "serta-cascade-canyon-medium",
        model: "Serta Cascade Canyon Medium",
        category: "Mattress",
        type: "Perfect Sleeper innerspring",
        height: "13 in",
        firmness: "Medium",
        feel: "Balanced support",
        bestFor: ["Back sleepers", "Side sleepers", "Couples"],
        keyFeatures: ["Q4 support system", "5-Zone Comfort", "Balanced cushioning"],
        warranty: "10 years",
        image: "/brand-assets/serta/sheep-lifestyle.jpg",
        availability: "Call for current Cascade Canyon Medium availability.",
      },
      {
        id: "serta-cascade-canyon-plush",
        model: "Serta Cascade Canyon Plush",
        category: "Mattress",
        type: "Perfect Sleeper innerspring",
        height: "13.5 in",
        firmness: "Plush",
        feel: "Softer Cascade comfort",
        bestFor: ["Side sleepers", "Pressure relief", "Plush support"],
        keyFeatures: ["Q4 support system", "5-Zone Comfort", "CoolFeel fabric"],
        warranty: "10 years",
        image: "/brand-assets/serta/sheep-lifestyle.jpg",
        availability: "Compare plush Cascade comfort in store.",
      },
      {
        id: "serta-cascade-pillow-top",
        model: "Serta Cascade Canyon Pillow Top",
        category: "Mattress",
        type: "Perfect Sleeper pillow top",
        height: "14 in",
        firmness: "Medium or plush",
        feel: "Cushioned pillow top",
        badge: "Pillow Top",
        bestFor: ["Side sleepers", "Pillow-top shoppers", "Pressure relief"],
        keyFeatures: ["Q4 support system", "5-Zone Comfort", "Added pillow-top cushioning"],
        warranty: "10 years",
        image: "/brand-assets/serta/sheep-stretch.jpg",
        availability: "Ask which Cascade Canyon Pillow Top feels are currently on display.",
      },
      {
        id: "serta-cascade-range",
        model: "Serta Cascade Range",
        category: "Mattress",
        type: "Perfect Sleeper innerspring",
        height: "14-15 in",
        firmness: "Extra firm, medium, firm pillow top, or plush pillow top",
        feel: "Upgraded Cascade support",
        badge: "Upgrade",
        bestFor: ["Support seekers", "Back sleepers", "Premium Perfect Sleeper shoppers"],
        keyFeatures: ["920-density Q4 support", "5-Zone Comfort", "CoolFeel Plus fabric"],
        warranty: "10 years",
        image: "/brand-assets/serta/sheep-lifestyle.jpg",
        gallery: [
          "/brand-assets/serta/sheep-lifestyle.jpg",
        ...
        availability: "Visit the store to compare Cascade Range comfort options.",
      },
    ],
  }),
  withBrandAssets({
